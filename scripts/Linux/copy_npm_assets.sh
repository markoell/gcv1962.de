...
mkdir -p ${project_path}/assets/vendors/fontawesome && rsync -rv ${project_path}/node_modules/@fortawesome/fontawesome-free/ ${project_path}/assets/vendors/fontawesome
