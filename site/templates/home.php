    ...
    <div class="container mt-5">
        ...
        <?php if($next = page('home/Termine')): ?>
            ...
            <img src="<?=  asset('/assets/images/gcvLogo.svg')->url() ?>" class="logo mx-auto d-block" alt="Kater Logo">
                ...
                <!-- Modal -->
                <div class="modal fade" id="modalAppointments" tabindex="-1" role="dialog" aria-labelledby="modalAppointmentsTitle" aria-hidden="true">
                    <div class="modal-dialog modal-xl" role="document">
                        <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modalAppointmentsTitle"><?= $next->title()->html() ?></h5>
